...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sb_msgs-msg:<Pose> is deprecated: use sb_msgs-msg:Pose instead.")))

(cl:ensure-generic-function 'xpos-val :lambda-list '(m))
(cl:defmethod xpos-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:xpos-val is deprecated.  Use sb_msgs-msg:xpos instead.")
  (xpos m))

(cl:ensure-generic-function 'ypos-val :lambda-list '(m))
(cl:defmethod ypos-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:ypos-val is deprecated.  Use sb_msgs-msg:ypos instead.")
  (ypos m))

(cl:ensure-generic-function 'zpos-val :lambda-list '(m))
(cl:defmethod zpos-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:zpos-val is deprecated.  Use sb_msgs-msg:zpos instead.")
  (zpos m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:roll-val is deprecated.  Use sb_msgs-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:pitch-val is deprecated.  Use sb_msgs-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:yaw-val is deprecated.  Use sb_msgs-msg:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Pose>)))
  ...
  "1ee08947271b4f230fb2d5bc945eb424")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Pose)))
  "Returns md5sum for a message object of type 'Pose"
  "1ee08947271b4f230fb2d5bc945eb424")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pose>)))
  ...
  (cl:format cl:nil "float64 xpos~%float64 ypos~%float64 zpos~%~%float64 roll~%float64 pitch~%float64 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pose)))
  "Returns full string definition for message of type 'Pose"
  (cl:format cl:nil "float64 xpos~%float64 ypos~%float64 zpos~%~%float64 roll~%float64 pitch~%float64 yaw~%~%~%"))
