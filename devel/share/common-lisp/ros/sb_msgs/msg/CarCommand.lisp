...
(cl:defmethod priority-val ((m <CarCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:priority-val is deprecated.  Use sb_msgs-msg:priority instead.")
  (priority m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CarCommand>)))
  ...
  "c31a3d204e29a9c88edbb8e52ee6bad6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CarCommand)))
  "Returns md5sum for a message object of type 'CarCommand"
  "c31a3d204e29a9c88edbb8e52ee6bad6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CarCommand>)))
  ...
  (cl:format cl:nil "#Car command that arduinoDriver or furiousDriver can understand~%~%float64 throttle # throttle value -1 < x < 1~%float64 steering # steering value -1 < x < 1~%float64 priority # priority value  0 < x < 1~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CarCommand)))
  "Returns full string definition for message of type 'CarCommand"
  (cl:format cl:nil "#Car command that arduinoDriver or furiousDriver can understand~%~%float64 throttle # throttle value -1 < x < 1~%float64 steering # steering value -1 < x < 1~%float64 priority # priority value  0 < x < 1~%~%~%"))
