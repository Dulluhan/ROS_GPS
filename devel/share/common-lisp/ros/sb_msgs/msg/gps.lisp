...
(cl:defmethod cl:initialize-instance :after ((m <gps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sb_msgs-msg:<gps> is deprecated: use sb_msgs-msg:gps instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:data-val is deprecated.  Use sb_msgs-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'compass-val :lambda-list '(m))
(cl:defmethod compass-val ((m <gps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sb_msgs-msg:compass-val is deprecated.  Use sb_msgs-msg:compass instead.")
  (compass m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<gps>)))
  ...
  "4369e7d0238f02434b28b289196c78ce")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'gps)))
  "Returns md5sum for a message object of type 'gps"
  "4369e7d0238f02434b28b289196c78ce")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<gps>)))
  ...
  (cl:format cl:nil "#gps_message ~%~%string data # lat and long in string format~%float64 compass # compass direction (angle relative to North)~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'gps)))
  "Returns full string definition for message of type 'gps"
  (cl:format cl:nil "#gps_message ~%~%string data # lat and long in string format~%float64 compass # compass direction (angle relative to North)~%~%~%~%"))
